...
public class CrearContrato_O extends javax.swing.JFrame {
    ...
    public CrearContrato_O(String ip, String suc) {
        dirIP = ip;
        idSucursal = suc;
    ...
    private void initComponents() {
        ...
        setTitle("D' Boutique - Crear Contrato");
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                if(t_cedula.getText().isEmpty()){
                    ...
                    limpiarCamposCliente();
                    AgregarCliente obj = new AgregarCliente(dirIP, t_cedula.getText(), t_cedula);
                }
            }
        });
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                limpiarCamposCliente();
                AgregarCliente obj = new AgregarCliente(dirIP, true, t_cedula);
            }
        });
        ...
        p_clienteLayout.setHorizontalGroup(
            ...
            .addGroup(p_clienteLayout.createSequentialGroup()
                ...
                .addGroup(p_clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(t_direccion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 436, Short.MAX_VALUE)
                    .addGroup(p_clienteLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addComponent(t_nombre, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 436, Short.MAX_VALUE)
                    .addGroup(p_clienteLayout.createSequentialGroup()
                        .addGroup(p_clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(t_tlf1, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)
                            .addComponent(t_correo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE))
                        .addGroup(p_clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(p_clienteLayout.createSequentialGroup()
                            ...
                            .addGroup(p_clienteLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                        .addGroup(p_clienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(t_tlf2, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE)
                            .addComponent(t_rif, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        /*jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Cant.", "Descripción", "Precio Unit.", "Total"
            }
        ));*/
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addContainerGap(2908, Short.MAX_VALUE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(p_cliente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(2697, 2697, 2697))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(41, 41, 41)
                .addComponent(l_logo, javax.swing.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
                .addGap(2666, 2666, 2666))
        );
                    ...
                    if(true){
                        ...
                        for(int ii=0;ii<jTable1.getRowCount();ii++){
                            if(jTable1.getValueAt(ii,0) != null){
                                ...
                                codigos[3] = codigo.substring(6,codigo.length());
    ...
    private void ingresarAccesorio(java.awt.event.ActionEvent evt) {
        ...
        //                   fa     ta   ca   tal   ma   ejm   precio
         //String datos[] = {"01", "01","01","XXL","01","1","100","100"};
         ...
         if(datos!=null){
             for(int i=0;i<jTable1.getRowCount();i++){
                 if(jTable1.getValueAt(i,0) == null){
                     ...
                     cod = datos[0] + datos[1] + datos[2] + datos[3];
